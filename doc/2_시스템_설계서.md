...
-   `src/services`: API 및 Firebase 통신 계층 (api.js, auth.js)
...
-   **Layout**: 사이드바, 헤더 등 공통 레이아웃 요소 관리.
...
-   **Authentication**: Firebase Authentication (Session Persistence 적용)
